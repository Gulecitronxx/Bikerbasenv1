...
| D7-F2 | critic | funktionalitet | **P2** | `js/home.js` | "548 motorcykler" — samme mc hos to kilder (≥7 dubletter) | **rettet** — "annoncer" i hero/knap, og tværkilde-afdublettering (7 grupper, 548 → 541; forhandlerens annonce viser "Samme annonce ligger også hos Gul og Gratis"). Måling i DECISIONS.md |
...
| D8-S4 | P3 | Undertitel-slot skiftede betydning fra kort til kort | **rettet** (24.08) — slot 2 er altid TYPEN (eller tom); klientens delModelOgVariant-gæt fjernet, hele modelstrengen i titlen |
| D8-M2/M4-rest, D8-F5 | P3 | Mærkesidens luft, cookie-sticky | **åbne** (kosmetik) |
